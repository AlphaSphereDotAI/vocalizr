...
COPY --from=ghcr.io/astral-sh/uv:latest@sha256:9653efd4380d5a0e5511e337dcfc3b8ba5bc4e6ea7fa3be7716598261d5503fa \
    /uv /uvx /bin/
...
RUN groupadd app && \
    ...
    apt-get install -y --no-install-recommends espeak-ng ffmpeg curl > /dev/null && \
